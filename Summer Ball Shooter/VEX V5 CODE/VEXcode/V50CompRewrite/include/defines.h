...
#define GLOBALS
namespace G{
static char TrackColor = 'R';
static char Alliance = 'R';
static int AutoNumber = 1;//76 red 106 blue 
static float RPMGoal = 600,rpm = 0, rpmError = 100.0, TurnDiff = 0, THeight = 0, TWidth = 0, TurnDir = 1, TXDist = 200, GlobalFlagOffset = 160,TYDist=0;
static int  fly = 4, R = 4, Tran = 0,LiftVar=2, Shoot = 0, SnapToFlag = 0, AutoRunning = 0, FlipCount;//flywheel//Roller//Transmission
static int MoveReturn=0;
static int T1 = 0, T3 = 0;
static float avgSpeed = 0;
static float avgError = 0;
static float GlobalGyro = 0;
static double AutoRPM=0;
static int Color=1;
static float FinalObject=20,TempObject=0;
static char VisionLR='R';
static float GlobalFlagOffsetL;
