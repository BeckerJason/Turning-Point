...
hood=off; 
SnapToFlag=off;   
Move(100,35,0,brake);   //move to ball under cap         
wait(300);
...
if (balls==two)
{
if (Color==1) {TurnTurret(-20);}///face left 
else {TurnTurret(20);} 
...
Move(80,-8.5,0,brake);   //move all the way back  x
...
roll=on;
Move(40,10,1,brake);
Move(80,-2,1,brake); //speed,dir,ramp,stop
wait(500);
Intake.set(false);    //lower intake piston
